...
public class ImageController {
    ...
    public String createImage(@RequestParam("file") MultipartFile file, @RequestParam("tags") String tags, Image newImage,
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        //Check whether the user of the current image is its owner as well
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, HttpSession session, Model model) {
        ...
        //We need to check whether or not the logged-in user is the owner of the image
        model.addAttribute("comments", image.getComments());
